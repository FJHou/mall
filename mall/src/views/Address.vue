<script>
  ...
  export default{
    ...
    methods: {
      ...
      addNewAddress () {
        axios.post('apis/users/addressAdd').then((res) => {
          if (res.data.status === '0') {
      ...
      getAddressList () {
        axios.post('apis/users/addressList').then((res) => {
          if (res.data.status === '0') {
            this.addressList = res.data.result.addressList
            console.log(this.addressList)
          }
                ...
                <ul>
                  <li v-for="(address, index) in addressListLimit" :key="index"> 
                    ...
                    <div class="addr-opration addr-del">
                      <a href="javascript:;" class="addr-del-btn" @click="addressDel(address.addressId)">
                  ...
                  <li class="addr-new">
                    <div class="add-new-inner">
                      ...
                      <p @click="addNewAddress">Add new address</p>
                    </div>
                  </li>
                </ul>
              </div>
